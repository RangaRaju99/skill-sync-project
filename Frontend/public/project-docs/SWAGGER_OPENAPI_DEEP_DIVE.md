...
Instead of sending a slack message asking "What fields do I send to `/api/sessions`?", the Frontend developer opens `https://skillsync.rangaraju.dev/swagger-ui.html`.
