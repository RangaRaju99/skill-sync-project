...
2.  **Container Phase:** We copy those static files into an **Nginx Docker Image**. Nginx is an ultra-fast web server that simply reads the static files and serves them to users hitting `https://skillsync.rangaraju.dev`.
