              ...
              <div className="p-6 space-y-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {ACCENT_COLORS.map((color) => (
                      <button
                        ...
                        className={`w-8 h-8 rounded-full border-2 transition-all flex items-center justify-center ${settings.primaryColor === color.value ? 'border-primary scale-110' : 'border-transparent'
                          }`}
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {['default', 'midnight', 'amoled', 'glass', 'gradient'].map((style) => (
                      <button
                        ...
                        className={`p-2 text-[10px] font-bold border rounded-lg transition-all capitalize ${settings.backgroundStyle === style ? 'border-primary bg-primary/5 text-primary' : 'border-outline-variant/10 bg-surface-container-low'
                          }`}
                      >
                        {style}
                      </button>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {['flat', 'glass', 'elevated', 'neon', 'minimal'].map((style) => (
                      <button
                        ...
                        className={`p-2 text-[10px] font-bold border rounded-lg transition-all capitalize ${settings.cardStyle === style ? 'border-primary bg-primary/5 text-primary' : 'border-outline-variant/10 bg-surface-container-low'
                          }`}
                      >
                        {style}
                      </button>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {['Outfit', 'Inter', 'Poppins', 'Space Grotesk', 'Manrope'].map((font) => (
                      <button
                        ...
                        className={`p-3 text-xs font-medium border rounded-xl transition-all ${settings.fontStyle === font ? 'border-primary bg-primary/5 text-primary' : 'border-outline-variant/10 bg-surface-container-low'
                          }`}
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      onClick={toggleTheme}
                      className={`p-4 border rounded-2xl flex flex-col items-center gap-2 transition-all ${theme === 'light' ? 'border-primary bg-primary/5' : 'border-outline-variant/10 bg-surface-container-low'
                        }`}
                    >
                    ...
                    <button
                      onClick={toggleTheme}
                      className={`p-4 border rounded-2xl flex flex-col items-center gap-2 transition-all ${theme === 'dark' ? 'border-primary bg-primary/5' : 'border-outline-variant/10 bg-surface-container-low'
                        }`}
                    >
