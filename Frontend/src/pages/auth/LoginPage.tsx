    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh]">
      <div className="flex items-center gap-3 mb-4 group transition-all">
        <img
          src={logo}
          alt="SkillSync Logo"
          className="w-12 h-12 object-contain group-hover:scale-110 transition duration-500"
          onError={(e: any) => { e.target.src = 'https://via.placeholder.com/48?text=S'; }}
        />
        <h1 className="text-4xl font-black tracking-tighter text-text-main">SkillSync</h1>
      </div>
      <p className="text-sm text-text-muted font-medium mb-8 text-center px-4 max-w-xs">
        Connecting ambition with expertise, one sync at a time.
      </p>

      <GlassCard className="w-full max-w-md p-8 sm:p-10">
        <h2 className="text-2xl font-extrabold text-text-main mb-6">Welcome back</h2>
        ...
        <div className="my-6 flex items-center justify-center space-x-4">
          ...
          <span className="text-xs font-bold text-text-muted tracking-wider uppercase">OR CONTINUE WITH</span>
          <div className="flex-1 h-px bg-border"></div>
        </div>
