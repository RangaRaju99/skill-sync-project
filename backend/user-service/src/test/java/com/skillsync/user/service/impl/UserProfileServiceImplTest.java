...
class UserProfileServiceImplTest {
    ...
    void updateProfile_shouldReturnUpdatedDto_whenProfileExists() {
        UpdateProfileRequestDto request = new UpdateProfileRequestDto("jdoe", "Jane Doe", "New bio", "9876543210", "Python,Django", null);
        UserProfileResponseDto dto = new UserProfileResponseDto();
    ...
    void updateProfile_shouldSetProfileIncomplete_whenSkillsNull() {
        UpdateProfileRequestDto request = new UpdateProfileRequestDto("jane", "Jane", "bio", "1234567890", null, null);
        UserProfileResponseDto dto = new UserProfileResponseDto();
